...
app.get('/widget', (req, res) => {
    try {
        ...
        res.json({ error: 'Widget not found', message: 'Widget em desenvolvimento' });
    }
});
    ...
    res.send(`
        ...
        <body>
            <div class="container">
                ...
                <p>Status: <span class="status">✅ ATIVO E FUNCIONANDO</span></p>
                ...
                <div class="feature">
                    ...
                    <p>• URL da API: <strong>https://web-production-4ca6.up.railway.app</strong></p>
                </div>
